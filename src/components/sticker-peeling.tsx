            ...
            if (loadedImageRef.current) {
                ...
                const texture =
                    ...
                    (() => {
                        ...
                        compCanvas.width = imageWidth * 4
                        compCanvas.height = imageHeight * 4
                        ...
                        if (ctx) {
                            ...
                            let drawWidth = compCanvas.width
                            let drawHeight = compCanvas.height
                            if (imgRatio > canvasRatio) {
                                drawHeight = compCanvas.width / imgRatio
                            } else {
                                drawWidth = compCanvas.height * imgRatio
                            }
                            ...
                            const x = (compCanvas.width - drawWidth) / 2
                            const y = (compCanvas.height - drawHeight) / 2
                            ctx.drawImage(img, x, y, drawWidth, drawHeight)
                        }
                        const t = new Texture(compCanvas)
                        t.needsUpdate = true
    ...
    const loadTexture = useCallback(() => {
        ...
        img.onload = () => {
            ...
            if (hasTexture) {
                ...
                const compCanvas = document.createElement("canvas")
                // Make the canvas high resolution and match the aspect ratio of the sticker
                compCanvas.width = imageWidth * 4
                compCanvas.height = imageHeight * 4
                const ctx = compCanvas.getContext("2d")
                if (ctx) {
                    ...
                    // Padding scale so the logo isn't touching the edges
                    const scale = 0.85
                    drawWidth *= scale
                    drawHeight *= scale
                ...
                texture = new Texture(compCanvas)
